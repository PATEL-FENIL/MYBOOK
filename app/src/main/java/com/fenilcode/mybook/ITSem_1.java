...
public class ITSem_1 extends AppCompatActivity {
    ImageButton btn1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itsem1);
        storage = FirebaseStorage.getInstance();

        btn1 = findViewById(R.id.Math_1);
        ...
        btn1 = findViewById(R.id.physics_2);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
